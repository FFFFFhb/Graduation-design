# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-03-07 12:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educated', models.CharField(default='', max_length=100)),
                ...
                ('fans_nums', models.IntegerField(default=0, verbose_name='粉丝数')),
                ('address', models.CharField(default='', max_length=100)),
                ('summary', models.TextField(verbose_name='个人简介')),
                ('short_summary', models.CharField(default='', max_length=100)),
                ('is_org', models.CharField(choices=[('yes', '是'), ('no', '否')], default='no', max_length=7)),
