...
class UserProfile(AbstractUser):
    ...
    educated = models.CharField(max_length=100,default=u'',null=True,blank=True)
    profession = models.CharField(max_length=100, default=u'',null=True,blank=True)
    ...
    city = models.CharField(max_length=50,verbose_name=u'所在城市',default='',null=True,blank=True)
    # age = models.IntegerField(default=18, verbose_name=u'年龄')
    summary = models.TextField(verbose_name=u'个人简介',null=True,blank=True)
    ...
    surface = models.ImageField(upload_to='image/%Y/%m',default=u'image/default_surface.jpg',max_length=100)
